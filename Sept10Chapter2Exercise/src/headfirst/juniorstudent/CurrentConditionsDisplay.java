...
/**
 * Model the display of Current Conditions from Chapter 2 of HFDP. Trying to
 * simulate a beginning student who only has a display updated when the display
 * requests to be updated by the pressing of a Get/Pull button.
 * 
 * @author dpowell2
 * @version 1.0
 */
public class CurrentConditionsDisplay extends JFrame {
	...
	/**
	 * 
	 * Sets an internal reference to a <code>WeatherData</code> instance and
	 * sets the top left corner of gui to [x,y]
	 * 
	 * @param weatherData
	 *            <code>WeatherData</code> instance used containing temperature,
	 *            presssure and humidity data
	 * @param x
	 *            int representing left side of Frame to be drawn
	 * @param y
	 *            int representing top side of Frame to be drawn
	 */
	...
	private void createGui() {
		 ...
		 *//**
			 * Sets temperature in text fields for temperature, humidity and
			 * presssure.
			 * 
			 * @param e
			 *            ActionEvent containing button reference clicked on.
			 *//*
