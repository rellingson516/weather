/*
 * CurrentConditionsDisplay.java 1.0 Sep 10, 2015
 *
...
/**
 * Class has data pushed to it from WeatherData. The point
 * demonstrated here is the student has an instance of this class used
 * by another class to automatically update it when the other class
 * has determined the data has changed.
 * 
 * @author dpowell2
 * @version 1.0
 * 
