...
/**
 * Data is pushed out to three gui instances whenever
 * measurementsChanged is called. The three gui instances are
 * hardwired and provided at instance instantiation
 * 
 * @author dpowell2
 * @version 1.0
 * 
...
public class WeatherData {
  ...
  /**
   * Registers three gui instances to simulate three guis used by
   * Weather Orama.
   * 
   ...
   */
  public WeatherData(CurrentConditionsDisplay aDisplay1,
                     CurrentConditionsDisplay aDisplay2,
